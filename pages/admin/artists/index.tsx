...
const Artists = ({_artists}: ArtistsProps) => {
    ...
    const filterData = (event: ChangeEvent<HTMLInputElement>) => {
        const searchedString = event.target.value
            .toLowerCase()
            .replace(/\s/g, "");
        const filteredData = data.artists.filter(
            (el: Artist) =>
    ...
    return (
        <>
            ...
            <div className="table">
                ...
                <div>
                    {checked.length > 0 && (
                        <button onClick={onDeleteArtist} className="drop">
                            Supprimer
                        </button>
                    )}
                </div>
            ...
            <div className="table-results">
                {state.map((artist) => (
                    <div className="table-item" key={artist._id}>
                        ...
                        <Link href={`/admin/artists/${artist._id}`}>
                            <a>
                                <div className="container-image">
                                    <span className="image">
                                        <Image
                                            ...
                                            alt={`image de l'artiste ${artist.pseudo}`}
                                            objectFit="cover"
                                        />
                                    </span>
                                    <p className="title">{artist.pseudo}</p>
                                </div>
