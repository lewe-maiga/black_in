...
export const NeastedLayout = ({ children }: { children: ReactElement | ReactChild }) => {
			...
			<div className="global-container">
				<nav className="side-nav">
					...
					<Link href="/admin/artists">
						<a
							className={`bloc-link ${
								router.asPath.includes("artists") ? "active" : ""
							}`}
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
					...
					<Link href="/admin/description">
						<a
							className={`bloc-link ${
								router.asPath.includes("description") ? "active" : ""
							}`}
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
							...
							>
								<path
									fill="currentColor"
									d="M6 22q-.825 0-1.412-.587Q4 20.825 4 20V4q0-.825.588-1.413Q5.175 2 6 2h8l6 6v12q0 .825-.587 1.413Q18.825 22 18 22Zm7-13h5l-5-5Zm-5 5h8v-2H8Zm0 4h8v-2H8Z"
								></path>
							</svg>
